...
let HeaderComponent = class HeaderComponent {
    ...
    openLoginDialog() {
        const dialogRef = this.dialog.open(_sign_in_dialog_sign_in_dialog_component__WEBPACK_IMPORTED_MODULE_3__["SignInDialogComponent"], {
            width: '400px'
        });
...
let NewOrderNologinComponent = class NewOrderNologinComponent {
    constructor(api) {
        this.api = api;
        this.orders = [];
    ...
    selectTypeRecvChangeHandler(event) {
        this.selectedTypeRecv = event.target.value;
    }
    addressIdenticalHandler(event) {
...
NewOrderNologinComponent.ctorParameters = () => [
    { type: _api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
];
...
let OrderRecapNologinComponent = class OrderRecapNologinComponent {
    constructor() {
